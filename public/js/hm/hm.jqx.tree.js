var HmTree = {
	...
	getUrlByType: function(type) {
		var url = undefined;
        switch (type) {
            case HmTree.T_GRP_DEFAULT: case HmTree.T_GRP_DEFAULT2: case HmTree.T_GRP_DEFAULT3:
				url = '/grp/getDefaultGrpTreeList.do';
				break;
            case HmTree.T_GRP_DEFAULT4:
            	url = '/grp/getDefaultGrpTreeListForQuality.do';
            	break;
    ...
    /**
		...
		create: function($tree, type, fnSelect, params, theme) {
			...
			case HmTree.T_AP_FILTER_GRP: url = '/grp/getApDefaultGrpTreeList.do'; break;
			case HmTree.T_AP_GRP_DEFAULT: url = '/grp/getApFilterGrpTreeList.do'; break;
			case HmTree.T_GRP_AUTH_RACK_CONF: url = '/grp/getDefaultRackGrpTreeList.do'; break;
			case HmTree.T_GRP_AUTH_AP_CONF: url = '/grp/getAuthConfApDefaultGrpTreeList.do'; break;
			case HmTree.T_GRP_EXTENSION: url = '/grp/getExtensionGrpTreeList.do'; break;
			case HmTree.T_GRP_LINE: url = '/grp/getLineGrpTreeList.do'; break;
			case HmTree.T_GRP_FLOW_IF: url = '/grp/getFlowIfGrpList.do'; break;
			}
		...
		updateData: function($tree, type, params, isClearSelection) {
			...
			switch(type) {
			case HmTree.T_GRP_DEFAULT: url = '/grp/getDefaultGrpTreeList.do'; break;
			case HmTree.T_GRP_DEFAULT4: url = '/grp/getDefaultGrpTreeListForQuality.do'; break;
			case HmTree.T_GRP_SEARCH: url = '/grp/getSearchGrpTreeList.do'; break;
			case HmTree.T_GRP_AUTHCONF: url = '/grp/getAuthConfDefaultGrpTreeListAll.do'; break;
			case HmTree.T_GRP_DEF_ALL: url = '/grp/getDefaultGrpTreeListAll.do'; break;
			case HmTree.T_GRP_IF: url = '/grp/getIfGrpTreeList.do'; break;
